...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--blind",help="blind option. [Default: %(default)s] ", action="store_true")
    ...
    if(args.blind=='true'):
        ...
        command +="combineTool.py -M Significance -d workspace.root --cl 0.90 -m 1.777;"
