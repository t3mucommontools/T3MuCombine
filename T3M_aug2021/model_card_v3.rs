...
sig_n_A1[2, 0.0, 7.0];
sig_gaus_sigma_A1[0.01,0.0001,0.5];
...
sig_n_B1[2, 0.0, 7.0];
sig_gaus_sigma_B1[0.01,0.0001,0.5];
...
sig_sigma_C1[0.03, 0.01, 0.05];
sig_alpha_C1[ 1, -20., 20.];
sig_n_C1[2, 0.0, 7.0];
sig_gaus_sigma_C1[0.01,0.0001,0.5];
...
sig_n_A2[2, 0.0, 7.0];
sig_gaus_sigma_A2[0.01,0.0001,0.5];
...
sig_n_B2[2, 0.0, 7.0];
sig_gaus_sigma_B2[0.01,0.0001,0.5];
...
sig_sigma_C2[0.03, 0.0, 0.05];
sig_alpha_C2[ 1, -20., 20.];
sig_n_C2[2, 0.0, 7.0];
sig_gaus_sigma_C2[0.01,0.0001,0.5];
...
sig_n_A3[2, 0.0, 7.0];
sig_gaus_sigma_A3[0.01,0.0001,0.5];
...
sig_n_B3[2, 0.0, 7.0];
sig_gaus_sigma_B3[0.01,0.0001,0.5];
...
sig_sigma_C3[0.03, 0.0, 0.05];
sig_alpha_C3[ 1, -20., 20.];
sig_n_C3[2, 0.0, 7.0];
sig_gaus_sigma_C3[0.01,0.0001,0.5];
