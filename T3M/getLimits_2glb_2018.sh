for card in BPH_vars_twoGlobalTracker; do
   echo $card
   ./run.py -v 2 -i inputdata/input_histograms_2018_2glbTrk_$card\.root -c model_card_twoGlobalTracker.rs -t twoGlobalTracker -r 2018 > 2018_2glbTrk_$card\.log 
...
for card in BPH_vars_threeGlobal; do
   echo $card
   ./run.py -v 3 -i inputdata/datacardT3Mu_dataset_2018_UL_may2021_newPhiveto_SBfixed_v3.root -c model_card_v3.rs -t threeGlobal -r 2018 > 2018_3glb_$card\.log 
