for card in BPH_preapproval_twoGlobalTracker; do
   echo $card
   ./run.py -v 2 -i inputdata/input_histograms_2017_2glbTrk_$card\.root -c model_card_v2.rs -t twoGlobalTracker -r 2017 > 2017_2glbTrk_$card\.log
...
for card in BPH_preapproval_threeGlobal; do
   echo $card
   ./run.py -v 3 -i inputdata/datacardT3Mu_dataset_2017_may2021_newPhi_adjSB_v3_W.root -c model_card_v3.rs -t threeGlobal -r 2017 > 2017_3glb_$card\.log
